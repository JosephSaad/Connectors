...
{
    public const string Prog = "HadoopConnector";
    ...
    public void PrintHelp(TextWriter writer)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("BDH (Hadoop data mart, Salesforce-shaped) → Microsoft 365 Copilot Graph connector.");
        sb.AppendLine();
...
public static class CommandRegistry
{
    public static CliParser BuildParser() => new(new List<CommandSpec>
    {
        ...
        {
            Name = "ingest-object",
            Description = "Ingest all records of a specific BDH object type.",
            Options = new List<OptionSpec>
            {
                new() { Name = "--type", TakesValue = true, Required = true, ValueName = "objectType",
                        Description = "BDH object type from config/schema.json (e.g. Contact, Account)." },
            },
        ...
        {
            Name = "ingest-item",
            Description = "Ingest a single BDH record by its Salesforce id.",
            Options = new List<OptionSpec>
            {
                new() { Name = "--id", TakesValue = true, Required = true, ValueName = "id",
                        Description = "Salesforce record id (e.g. 0035e00000abcde)." },
                new() { Name = "--object-type", TakesValue = true, Required = true, ValueName = "objectType",
                        Description = "Object type from config/schema.json (e.g. Contact)." },
            },
        ...
        new()
        {
            ...
            Options = new List<OptionSpec>
            {
                ...
                new() { Name = "--fix", TakesValue = false,
                        Description = "DELETE stale items (indexed but gone from BDH) from the connection." },
            },
        ...
        new()
        {
            ...
            Description = "Resolve BDH (Salesforce) users to Entra identities and report, without ingesting.",
            Options = new List<OptionSpec>
            {
        ...
        new()
        {
            ...
            Options = new List<OptionSpec>
            {
                new() { Name = "--strict", TakesValue = false,
                        Description = "Fail on warnings (incl. unfiltered objects) and require BDH + Graph connectivity." },
            },
