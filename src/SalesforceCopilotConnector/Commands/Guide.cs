...
//
// Running ``run.py guide`` displays a formatted reference covering:
//
...
{
    internal const string GuideText = "\n" + """
╔══════════════════════════════════════════════════════════════════════════════╗
...
""";
    ...
    /// <summary>Print the complete setup and usage guide.</summary>
    public static Task<bool?> CmdGuide(ParsedArgs args)
    {
        Console.Out.Write(GuideText);
        Console.Out.Flush();
