...
/// and <c>SECRET_SALESFORCE_CLIENT_SECRET</c> maps to <c>secret-salesforce-client-secret</c>.
/// </para>
///
/// <para>
...
public static class SecretProvider
{
    ...
    /// </para>
    /// </summary>
    /// <param name="envVarName">The environment-variable name (e.g. <c>SECRET_SALESFORCE_CLIENT_SECRET</c>).</param>
