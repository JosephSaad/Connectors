...
| `tests/SalesforceCopilotConnector.Tests/` | `tests/` — full pytest suite as xUnit + C# additions (819 tests) |
...
819 tests — a 1:1 port of the Python suite plus C#-side additions (SQL/HA,
