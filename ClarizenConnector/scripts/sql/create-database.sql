-- =============================================================================
-- Clarizen Copilot Connector — SQL Server state backend provisioning
-- =============================================================================
...
(
    ConnectorId    NVARCHAR(64)   NOT NULL,
    ClarizenId     NVARCHAR(256)  NOT NULL,
    PrincipalType  NVARCHAR(16)   NOT NULL,   -- 'user' | 'group'
    Email          NVARCHAR(320)  NULL,
    EntraId        NVARCHAR(64)   NULL,
    UpdatedUtc     DATETIME2(7)   NOT NULL,
    CONSTRAINT PK_Principals PRIMARY KEY (ConnectorId, ClarizenId)
);
