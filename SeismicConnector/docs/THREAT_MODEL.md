...
| R | "We never fetched/ingested X" disputes | Run logs (INFO+, rotated), per-crawl reconciliation report, correlation ids on every structured line | Log retention is operator-set (`LOG_RETENTION_DAYS`) |
